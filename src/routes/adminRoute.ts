...
router
    ...
    .post(authMW, checkAutherizationMW(['admin']),validationArry,validationMW, createAdmin)
    .put(authMW, checkAutherizationMW(['admin']),validationUpdataArry,validationMW, updateAdmin)
router
    .route('/admin/:id')
