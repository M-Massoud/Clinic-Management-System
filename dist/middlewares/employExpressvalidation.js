...
exports.validationUpdataArry = [
    (0, express_validator_1.body)('fullName').optional()
        .isAlpha()
        .withMessage('Employe fullName shoud be characters'),
    ...
    (0, express_validator_1.body)("mobile").optional().isMobilePhone('ar-EG').withMessage("Employe mobile should be mobile numbers").isLength({ min: 10, max: 14, }).withMessage("mobile length should be between 10 and 14  numbers"),
    (0, express_validator_1.body)('role').optional()
        .isAlpha()
        .withMessage('Employe role shoud be characters'),
];
